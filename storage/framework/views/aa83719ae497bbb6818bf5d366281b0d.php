...
<?php endif; ?>
    ...
    <!------- Azfar Hussain Email Tiny Mce --------->
    
   <!-- <script src="https://cdn.tiny.cloud/1/pp42ieqsxwpgrk840yyr05ahcxykkhjqwhsu07xizu3tpr2j/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>-->
   
   <!----------- Tech Globry Email Tiny Mce -------------->
   <script src="https://cdn.tiny.cloud/1/pulyymnhypzs427stf8lvpbxvz9cewz2ls42psmk2ny5m2sv/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Loop through spans to find the one with the text "Chat"
            spans.forEach(span => {
                if (span.textContent.trim() === 'Chat') {
                    // Create an <a> element
                    const link = document.createElement('a');
                    link.href = 'https://www.remind.com/log_in'; // Set the link URL
                    link.textContent = span.textContent; // Set the link text
                    link.target = '_blank'; // Open the link in a new tab

                    // Replace the <span> with the <a> element
        ...
        tinymce.init({
            ...
            setup: function (editor) {
                editor.on('keydown', function (e) {
                    if (this.getContent().length >= 10000) {
                        e.preventDefault();
                    }
                });
            }
        });
    </script><?php /**PATH /home/r5g3w8ncebh7/public_html/portal.umaracademy.org/resources/views/backEnd/partials/header.blade.php ENDPATH**/ ?>