            ...
            <div class="white-box homework_pages">
               ...
               <div class="">
                ...
                <?php endif; ?>
                  ...
                  <div class="row md-20">
                     <div class="col-lg-12">
                        <div class="primary_input tinymce-textarea">
                           <label class="primary_input_label" for=""><?php echo app('translator')->get('common.description'); ?> <span class="text-danger"> *</span> </label>
                           <textarea class="primary_input_field tinymce-textarea form-control<?php echo e($errors->has('description') ? ' is-invalid' : ''); ?>" cols="0" rows="4" name="description" id="description *"><?php echo e($homeworkList->description); ?></textarea>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/r5g3w8ncebh7/public_html/portal.umaracademy.org/resources/views/backEnd/homework/homeworkEdit.blade.php ENDPATH**/ ?>