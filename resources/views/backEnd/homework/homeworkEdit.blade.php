                  ...
                  <div class="row md-20">
                     <div class="col-lg-12">
                        <div class="primary_input tinymce-textarea">
                           ...
                           <textarea class="primary_input_field tinymce-textarea form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" cols="0" rows="4" name="description" id="description *">{{$homeworkList->description}}</textarea>
