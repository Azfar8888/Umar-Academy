            ...
            <div class="single-meta">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="name">
                            <?php if(isset($homeworkDetails)): ?>
                              <?php echo $homeworkDetails->description; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/r5g3w8ncebh7/public_html/portal.umaracademy.org/resources/views/backEnd/studentPanel/studentHomeworkView.blade.php ENDPATH**/ ?>